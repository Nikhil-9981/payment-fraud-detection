...
def downloadFiles():
  ...
  gdown.download(f"https://drive.google.com/uc?id={st.secrets['KM_C_FEATURES']['id']}", f'km_C_features.pkl', quiet=False)
  gdown.download(f"https://drive.google.com/uc?id={st.secrets['KM_D_FEATURES']['id']}", f'km_D_features.pkl', quiet=False)
  gdown.download(f"https://drive.google.com/uc?id={st.secrets['KM_V_FEATURES']['id']}", f'km_V_features.pkl', quiet=False)
  gdown.download(f"https://drive.google.com/uc?id={st.secrets['PCA_C_FEATURES']['id']}", f'PCA_C_features.pkl', quiet=False)
  gdown.download(f"https://drive.google.com/uc?id={st.secrets['PCA_D_FEATURES']['id']}", f'PCA_D_features.pkl', quiet=False)
  gdown.download(f"https://drive.google.com/uc?id={st.secrets['PCA_V_FEATURES']['id']}", f'PCA_V_features.pkl', quiet=False)
  gdown.download(f"https://drive.google.com/uc?id={st.secrets['MODEL']['id']}", f'model.pkl', quiet=False)
